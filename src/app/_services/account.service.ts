...
import {BookingUser} from "@app/_models/bookingUser";
...
export class AccountService {
    ...
    public getBookingUser(referenceEmail:string, current:boolean, app:string) {
        ...
        return this.http.get<[BookingUser]>(`${environment.apiUrl}/TutenREST/rest/user/${referenceEmail}/bookings?current=${current}`, httpOptions);
    }
